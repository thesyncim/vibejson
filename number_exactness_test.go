...
// TestFloatHardCases ports the killer values from the simdjson C++ number
// tests and the classic strtod test suites: subnormal boundaries, overflow
// boundaries, exact halfway points, mantissa truncation, and exponent clamps.
