...
func (c *decoderCursor) definedInt(dst any) error {
	...
	if v.Kind() != reflect.Pointer || v.IsNil() {
		panic("vibejson: decoderCursor.Int destination is not a non-nil pointer")
	}
	elem := v.Elem()
	var err error
	switch elem.Kind() {
	...
	case reflect.Int64:
		...
		elem.SetInt(value)
	default:
		panic("vibejson: decoderCursor.Int destination has non-integer element")
	}
...
func (c *decoderCursor) definedUint(dst any) error {
	v := reflect.ValueOf(dst)
	if v.Kind() != reflect.Pointer || v.IsNil() {
		panic("vibejson: decoderCursor.Uint destination is not a non-nil pointer")
	}
	elem := v.Elem()
	var err error
	switch elem.Kind() {
	...
	case reflect.Uintptr:
		...
		elem.SetUint(uint64(value))
	default:
		panic("vibejson: decoderCursor.Uint destination has non-unsigned element")
	}
	return retagDefinedCursorError(err, elem.Type())
}
...
func (c *decoderCursor) definedFloat(dst any) error {
	v := reflect.ValueOf(dst)
	if v.Kind() != reflect.Pointer || v.IsNil() {
		panic("vibejson: decoderCursor.Float destination is not a non-nil pointer")
	}
	elem := v.Elem()
	var err error
	switch elem.Kind() {
	...
	case reflect.Float64:
		...
		elem.SetFloat(value)
	default:
		panic("vibejson: decoderCursor.Float destination has non-float element")
	}
	return retagDefinedCursorError(err, elem.Type())
}
