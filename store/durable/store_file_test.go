...
func TestFileStoreTTLPersistsAndExpiresThroughSnapshots(t *testing.T) {
	file, err := os.CreateTemp(t.TempDir(), "file-fs-ttl-*")
	if err != nil {
		t.Fatal(err)
	}
	defer file.Close()
