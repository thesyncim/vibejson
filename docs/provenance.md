...
| `GO-CORPUS-001` | `tests/stdlib/testdata`, `tests/stdlib/models.go`, `benchmarks/legacy/stdlib_models_test.go` | Pinned Go commit `03845e30f7b73d1703bd8c21017297f6eecb76d6`, source paths recorded in `tests/stdlib/README.md`, and BSD license in adjacent `testdata/LICENSE`. Payloads are byte-for-byte copies and the canonical models are mechanically extracted once in `tests/stdlib`; the legacy benchmark file is a checked alias shim to those models. The corpus material is byte-identical to the prior `d468ad3648be469ffc4090e4586c29709182d6b6` pin. `scripts/check-stdlib-corpus.sh` verifies the source revision, generated corpus, canonical models, and alias shim. |
