...
| `GO-FIELDS-001` | `typed_fields.go:resolveStructFields`; `typed_compile.go:validTypedTag` | Go commit `d468ad3648be469ffc4090e4586c29709182d6b6`, `src/encoding/json/encode.go:{typeFields,isValidTag}`; Go Authors, BSD-3-Clause, `LICENSE-GO` | Compiled-field layout, pointer-hop metadata, and opt-in `,inline` support. Struct-field parity tests cover visibility and dominance. |
