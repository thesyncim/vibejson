...
var (
	...
	ErrWriterLocked = errors.New("slopjson: Store page file already has a writer")
	// ErrWriterLockUnsupported rejects mutable open on a platform where this
	// package cannot enforce the single-writer invariant.
	ErrWriterLockUnsupported = errors.New("slopjson: Store page writer locking is unsupported")
)
